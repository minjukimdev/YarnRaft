 ...
 * This file demonstrates how to integrate Yarnraft with a web frontend
 */

// For React/Vue/Angular applications
export class YarnraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YarnraftClient(provider, contractAddress);
